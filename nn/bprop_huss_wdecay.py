...
input_file1 = '/Users/Chris/SLA/stat/data/orig/huss_remap_Amon_CNRM-CM5_historical_r1i1p1_197901-200512.nc'
input_file2 = '/Users/Chris/SLA/stat/data/orig/huss_remap_Amon_GFDL-CM3_historical_r1i1p1_197901-200512.nc'
input_file3 = '/Users/Chris/SLA/stat/data/orig/huss_remap_Amon_IPSL-CM5A-LR_historical_r1i1p1_197901-200512.nc'
input_file4 = '/Users/Chris/SLA/stat/data/orig/huss_remap_Amon_MIROC-ESM_historical_r1i1p1_197901-200512.nc'
input_file5 = '/Users/Chris/SLA/stat/data/orig/huss_remap_Amon_MIROC5_historical_r5i1p1_197901-200512.nc'
input_file6 = '/Users/Chris/SLA/stat/data/orig/huss_remap_Amon_NorESM1-M_historical_r1i1p1_197901-200512.nc'
target_file = '/Users/Chris/SLA/stat/data/orig/huss_NCEP2_197901-200512.nc'
...
for i in range(103,114):
	for j in range(30,41):		
		ex1 = input1.variables['huss'][:,j,i]
		ex2 = input2.variables['huss'][:,j,i]
		ex3 = input3.variables['huss'][:,j,i]
		ex4 = input1.variables['huss'][:,j,i]
		ex5 = input1.variables['huss'][:,j,i]
